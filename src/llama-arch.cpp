...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_FLASHHEAD_CENTROIDS,                    "flashhead.centroids" },
    { LLM_TENSOR_FLASHHEAD_C2T,                          "flashhead.c2t" },
    { LLM_TENSOR_FLASHHEAD_STATIC,                       "flashhead.static" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_FLASHHEAD_CENTROIDS,        {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FLASHHEAD_C2T,              {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
    {LLM_TENSOR_FLASHHEAD_STATIC,           {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
